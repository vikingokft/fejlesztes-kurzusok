...
while(!bookPlaced && i < this.numberOfShelves) {

Shelf shelf = this.shelves.get(i);

double newSumOfWeights = shelf.sumOfWeights + weight;

if(newSumOfWeights <= shelf.loadCapacity) {

shelf.addBook(title, weight);
