...
// 7) Kettő változó deklarálása a számok lementéséhez.

int number_1;

int number_2;

// 8) Üzenet a felhasználó számára és az első szám bekérése.

std::cout << "Add meg az első számot: ";

std::cin >> number_1;

// 9) Üzenet a felhasználó számára és a második szám bekérése.

std::cout << "Add meg a második számot: ";

std::cin >> number_2;

// 10) A felhasználó által kiválasztott művelet végrehajtása az
alábbiakból.
